...
class WaypointUpdater(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.pose and self.base_waypoints and self.waypoint_tree:
                ...
                rospy.logwarn("closest waypoint is: {0}", format(closest_waypoint_idx))
    ...
    def get_closest_waypoint_idx(self):
        ...
        # If closest point is behind the vehicle, use next index instead
        if val > 0:
    ...
    def publish_waypoints(self, closest_idx):
        ...
        rospy.logwarn("Publishing waypoint range: {0} - {0}", format(closest_idx), format(closest_idx + LOOKAHEAD_WPS))
